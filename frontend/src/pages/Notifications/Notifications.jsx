...
export default function Notifications() {
  return (
    <motion.div {...FADE_IN} className="space-y-6 p-6">
      <div>
        <h1 className="text-2xl font-bold text-semantic-text-primary tracking-tight">Notifications</h1>
        <p className="text-semantic-text-secondary mt-1">View and manage your enterprise alerts.</p>
      </div>
